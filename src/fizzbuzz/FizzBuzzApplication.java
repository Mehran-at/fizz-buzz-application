...
//      b. Define the fizzBuzz action that receives a number and returns a word depending on some factors. The action returns Fizz if the number is multiple of three and Buzz if it is a multiple of five. For numbers that are multiples of both three and five it returns FizzBuzz. For numbers that are either, then it just returns the number as text.
...
public class FizzBuzzApplication {
    public static void main(String[] args) {
        ...
        System.out.println(fizzBuzzFinder.findFizzBuzz(number));
